...
pokemonWorld = {
    ...
    'audino':     {'type': 'normal',      'evolveAt': None,   'evolveTo': None,           'baseDef': 130,  'baseSpeed': 110, 'startAttacks': [(pound), (tackle), (headcharge), (disable)],                       'learnableAttacks': [(quickattack), (thunderbolt), (agility), (irontail), (thunderpunch), (discharge), (bolttackle), (electroball), (catastropika)][::-1]       },
